...
**JC Grading -3** You want to create functions mean.medicalRecord, print.medicalRecord, and plot.medicalRecord.  Then you can simply call mean(obj) when obj is of class medicalRecord.
...
**JC Grading -4**
The suffix .cohort (as in mean.cohort) works on objects assigned the class 'cohort'.  You've created an object called cohort, but it is assigned the class 'group'.  You should be able to call mean(cohort) and print(cohort).  